...
- `examples/transition-playbook.md` — the longer org-level playbook (phases, governance, metrics).
...
- Long-form transition playbook: `examples/transition-playbook.md`
...
- Per-archetype repo templates: `examples/repo-setup-batch/`, `examples/repo-setup-api/`
